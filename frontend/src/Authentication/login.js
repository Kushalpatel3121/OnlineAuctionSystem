                    ...
                    <div className=''>
                        <form className=''>
                            <div className="select-none mb-7">
                                ...
                                <br />
                                <input type="text" name='username' className='focus:outline-none border-b-2 border-b-primary-blue p-2 w-64 mt-0 rounded-sm bg-secondary-sup-gray-4 focus:border-b-2 text-sm' required></input>
                            </div>

                            <div className="select-none mb-5">
                                <label for="password" className="text-md font-bold"> Password : </label>
                                <br />
                                <input type="password" name='password' className='focus:outline-none border-b-2 border-b-primary-blue p-2 w-64 mt-0 rounded-sm bg-secondary-sup-gray-4 focus:border-b-2 text-sm' required></input>

                            </div>

                            <div className="select-none">
                                {/* <button type='submit'> Login </button> */}
                                <input type="submit" value={"Login"} className="rounded-sm text-md text-primary-white-1 justify-self-center border-solid border-2 border-primary-white-1 mt-4 w-64 h-7 bg-primary-blue/75 hover:bg-primary-blue-light"></input>
                            </div>
