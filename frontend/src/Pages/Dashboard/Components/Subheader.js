...
const Subheader = () => {
  ...
  const checkError = () => {
    isError = false;
    if(NewAuctionDetails.auctionName == '')
    {setNewAuctionError((values)=>({...values, auctionName: 'Auction name is required'})); isError = true;}
    if(NewAuctionDetails.auctionType == '')
    {setNewAuctionError((values)=>({...values, auctionType: 'Please select auction type'})); isError = true;}
    if(NewAuctionDetails.auctionEndingDate == '' && NewAuctionDetails.auctionType != 'Live Auction')
    {setNewAuctionError((values)=>({...values, auctionEndingDate: 'Please select auction ending date'})); isError = true;}
    if(NewAuctionDetails.auctionEndingTime == '' && NewAuctionDetails.auctionType != 'Live Auction')
    {setNewAuctionError((values)=>({...values, auctionEndingTime: 'Please select auction ending time'})); isError = true;}
    if(NewAuctionDetails.auctionStartingDate == '')
    {setNewAuctionError((values)=>({...values, auctionStartingDate: 'Please select auction starting date'})); isError = true;}
    if(NewAuctionDetails.auctionStartingTime == '')
    {setNewAuctionError((values)=>({...values, auctionStartingTime: 'Please select auction starting time'})); isError = true;}
    if(productImage == '')
    {setNewAuctionError((values)=>({...values, productImage: 'Please select product image'})); isError = true;}
    if(NewAuctionDetails.productAge == '')
    { setNewAuctionError((values)=>({...values, productAge: 'Please enter the age of product'})); isError = true;}
    if(NewAuctionDetails.productName == '')
    {setNewAuctionError((values)=>({...values, productName: 'Please enter the name of product'})); isError = true;}
    if(NewAuctionDetails.productCategory == '')
    {  setNewAuctionError((values)=>({...values, productCategory: 'Please select the category of product'})); isError = true;}
    if(NewAuctionDetails.productDescription == '')
    {  setNewAuctionError((values)=>({...values, productDescription: 'Please enter the description of product'})); isError = true;}
    if(NewAuctionDetails.productBasePrice == '')
    {  setNewAuctionError((values)=>({...values, productBasePrice: 'Please enter the base price of product'})); isError = true;}
    if(NewAuctionDetails.productAge < 0)
    {  setNewAuctionError((values)=>({...values, productAge: 'Product age can\'t be negative'})); isError = true;}
    if(NewAuctionDetails.productBasePrice < 0)
    {  setNewAuctionError((values)=>({...values, productBasePrice: 'Product price can\'t be negative'})); isError = true;}
    if(NewAuctionDetails.productCategory == 'Other' && otherCategory == '')
    {  setNewAuctionError((values)=>({...values, otherCategory: 'Specify other catergory'})); isError = true;}
  }
